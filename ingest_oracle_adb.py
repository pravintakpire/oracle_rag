...
ORACLE_USER_ADB = os.environ["ORACLE_USER_ADB"]
ORACLE_PASSWORD_ADB = os.environ["ORACLE_PASSWORD_ADB"]
ORACLE_DSN_ADB = os.environ["ORACLE_DSN_ADB"]
...
def main():
    ...
    with oracledb.connect(user=ORACLE_USER_ADB, password=ORACLE_PASSWORD_ADB, dsn=ORACLE_DSN_ADB, config_dir=TNS_ADMIN, wallet_location=TNS_ADMIN, wallet_password=wallet_password) as connection:
