...
def main():
    ...
    # connect to Oracle
    conn = oracledb.connect(user=ORACLE_USER_ADB, password=ORACLE_PASSWORD_ADB, dsn=ORACLE_DSN_ADB, config_dir=TNS_ADMIN, wallet_location=TNS_ADMIN, wallet_password=wallet_password)
